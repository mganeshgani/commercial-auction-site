...
const { saveTeamLogo, deleteImage } = require('../utils/imageUpload');
...
exports.createTeam = async (req, res) => {
  try {
    ...
    const uploadPromise = req.file ? saveTeamLogo(req.file.buffer) : Promise.resolve('');
...
exports.updateTeam = async (req, res) => {
  try {
    ...
    const uploadPromise = req.file ? saveTeamLogo(req.file.buffer) : Promise.resolve(null);
